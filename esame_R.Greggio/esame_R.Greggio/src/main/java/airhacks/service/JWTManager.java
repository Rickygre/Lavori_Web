...
public class JWTManager {
    ...
    private static final String ISS = "airhacks.service.segnalibro";

    public String generate(Utente utente) {

        try {
            JSONObject jwt = generateJWT(utente);
    ...
    private JSONObject generateJWT(Utente utente) {
        ...
        jwt.put("sub", utente.getId().toString());
        jwt.put("upn", utente.getEmail());
        jwt.put("groups", loadGroups(utente));
        return jwt;

    }

    private JSONArray loadGroups(Utente utente) {
